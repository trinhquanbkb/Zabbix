...
const viewsDetails: ViewsDetailTypes[] = [
    {
        page: '/a2ztech/dashboard/ecommerce',
        bounce_rate: '87.5%',
    },
    {
        page: '/a2ztech/dashboard/analytics',
        bounce_rate: '21.48%',
    },
    {
        page: '/a2ztech/apps/calender',
        bounce_rate: '63.59%',
    },
    {
        page: '/a2ztech/apps/email',
        bounce_rate: '7.12%',
    },
    {
        page: '/a2ztech/custom/pages',
        bounce_rate: '86.46%',
    },
    {
        page: '/a2ztech/components/ucharts',
        bounce_rate: '98.48%',
    },
    {
        page: '/a2ztech/components/charts',
        bounce_rate: '23.79%',
    },
    {
        page: '/a2ztech/components/tables',
        bounce_rate: '21.27%',
    },
];

export { dataSeries, sources, engagementOverviews, platforms, channels, viewsDetails };
